...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Pre-seleccionar tienda desde localStorage
        const tiendaGuardada = JSON.parse(localStorage.getItem('tiendaSeleccionada'));
        if (tiendaGuardada && tiendaGuardada.id) {
            const selectTienda = document.getElementById('tienda_id');
            selectTienda.value = tiendaGuardada.id;
        }
    });
