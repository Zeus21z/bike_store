...
$stmt_categoria = $conexion->prepare("SELECT * FROM categorias WHERE category_id = :id");
...
$stmt_productos->execute([':category_id' => $categoria_id]);
...
<div class="container">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="mb-0"><?php echo htmlspecialchars($categoria['descripcion']); ?></h1>
