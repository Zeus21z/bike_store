...
// --- INICIO: AÑADIR CÓDIGO QR ---
// Generar contenido para el QR (ej: datos fiscales o un enlace a la factura online)
$qr_content = "Factura Bike Store\nPedido: {$pedido_id}\nCliente: " . htmlspecialchars($pedido['nombre'] . ' ' . $pedido['apellido']) . "\nTotal: $" . number_format($total, 2);

// Generar el QR como una imagen temporal
$qr_temp_file = tempnam(sys_get_temp_dir(), 'qr') . '.png';
QRcode::png($qr_content, $qr_temp_file, QR_ECLEVEL_L, 3);

// Añadir el QR al PDF en la esquina superior derecha de la tabla de totales
$pdf->Image($qr_temp_file, 160, ($pdf->GetY() - 15), 30, 30, 'PNG');

// Limpiar el archivo temporal
@unlink($qr_temp_file);
// --- FIN: AÑADIR CÓDIGO QR ---
